...
<div class="headerBar">
    ...
    <div class="logoBar">
        <div class="comWidth">
            <div class="logo fl">
                <a href="index.php"><img src="public/images/logo.jpg" alt="慕课网"></a>
            </div>
    ...
    <div class="description clearfix">
        <div class="leftArea">
            <div class="description_imgs">
                <div class="big">
                    <img src="public/images/des_big.jpg" alt="">
                </div>
                <ul class="des_smimg clearfix">
                    <li><a href="#"><img src="public/images/des_sm.jpg" class="active" alt=""></a></li>
                    <li><a href="#"><img src="public/images/des_sm2.jpg" alt=""></a></li>
                    <li><a href="#"><img src="public/images/des_sm.jpg" alt=""></a></li>
                    <li><a href="#"><img src="public/images/des_sm2.jpg" alt=""></a></li>
                    <li><a href="#"><img src="public/images/des_sm.jpg" alt=""></a></li>
                </ul>
            </div>
    ...
    <div class="leftArea">
        <div class="recommend">
            ...
            <div class="item">
                <div class="item_cont">
                    <div class="img_item">
                        <a href="#"><img src="public/images/shopImg.jpg" alt=""></a>
                    </div>
    ...
    <div class="rightArea">
        <div class="des_infoContent">
            ...
            <div class="info_text">
                ...
                <p>现在就是买mini的好时候！换代清仓直降，但苹果品质不变！A5双核，内置Lightning闪电接口，正反可插，方便人性。小身材，炫丽的7.9英寸显示屏，7.2mm的厚度，薄如铅笔。女生包包随身携带更时尚！facetime视频通话，与密友24小时畅聊不断线。微信倾力打造，你的智能助理。苹果的牌子就不用我说了，1111补仓，存货不多哦！</p>
                <div class="hr_45"></div>
                <img src="public/images/pad.jpg" class="center">
                <div class="hr_45"></div>
            </div>
        </div>
        <div class="hr_15"></div>
                ...
                <div class="review_list clearfix">
                    <div class="review_userHead fl">
                        <div class="review_user">
                            <img src="public/images/userhead.jpg" alt="">
                            <p>61***42</p>
                            <p>金色会员</p>
                        </div>
                    </div>
...
<div class="footer">
    ...
    <p class="web">
        <a href="#"><img src="public/images/webLogo.jpg" alt="logo"></a>
        <a href="#"><img src="public/images/webLogo.jpg" alt="logo"></a>
        <a href="#"><img src="public/images/webLogo.jpg" alt="logo"></a>
        <a href="#"><img src="public/images/webLogo.jpg" alt="logo"></a></p>
</div>
</body>
</html>
